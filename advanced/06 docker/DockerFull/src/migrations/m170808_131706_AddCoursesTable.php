...
class m170808_131706_AddCoursesTable extends Migration
{
    public function safeUp()
    {
        ...
        $this->addForeignKey('FK_lesson_sport', 'lessons', 'id_course', 'courses', 'id');
    ...
    {
        echo "m170808_131706_AddCoursesTable cannot be reverted.\n";
